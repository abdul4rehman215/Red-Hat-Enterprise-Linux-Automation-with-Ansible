...
class CloudInventory:
    ...
    def build_inventory(self):
        ...
        # Create environment-based group (children of discovered role groups)
        role_groups = [k for k in self.inventory.keys() if k not in ["all", "_meta"]]
        env_group = f"{self.environment}_servers"
        self.inventory[env_group] = {
            "children": role_groups
        }
